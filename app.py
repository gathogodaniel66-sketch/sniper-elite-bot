...
# --- 1. UI STYLING ---
st.set_page_config(page_title="Slimmy Pro V17.7", layout="centered") 
st.markdown("""
    <style>
...
# --- 4. HEADER ---
st.markdown("<div class='bank-header'><h2 style='color:white; margin:0;'>SLIMMY PRO</h2><p style='color:#8cc63f; margin:0; font-size:12px;'>V17.7 OWNER EDITION</p></div>", unsafe_allow_html=True)
...
if choice == "Register":
    ...
    if st.sidebar.button("✨ Create Account"):
        ...
        else: st.sidebar.error("❌ Email/Password required!")
