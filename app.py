...
st.sidebar.markdown("---")
# Adjusted to $1.00 stake for your $36 balance to be profitable but safe
...
# --- 8. SOVEREIGN ENGINE ---
async def worker():
    api = DerivAPI(app_id=1089) # Optimized for stable API responses
    try:
...
# --- 9. STABLE THREADED EXECUTION ---
if st.session_state.running:
    # Use a try-except to handle loop management
    try:
